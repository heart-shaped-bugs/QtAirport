...
QString Passenger::getFlightNumber() const {
    return flightNumber;
}

void Passenger::setId(int value) {
    id = value;
}

void Passenger::setFirstName(const QString &value) {
    firstName = value;
}

void Passenger::setLastName(const QString &value) {
    lastName = value;
}

void Passenger::setFlightNumber(const QString &value) {
    flightNumber = value;
}
